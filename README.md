...
Create a ROS package called yolo_light using `catkin_create_pkg yolo_light std_msgs rospy roscpp`. Clone this repository can copy all contents into the yolo_light package. You should then perform the following operations. 
